...
router.get(
  ...
  validationHandler(validationResult, "Product ID not given"),
...
router.put(
  "/addOfferToCart",
  authorize([role.Client]),
  cartController.addOfferToCart
);
router.get(
  "/cartOfferQuantity",
  authorize([role.Client]),
  cartController.getOfferQuantityInCart
);
...
router.post(
  "/addCommentThread",
  authorize([role.Client]),
  commentController.addCommentThread
);
router.post(
  "/addCommentReply",
  authorize([role.Client]),
...
router.get(
  "/currentUser",
  authorize([role.Client]),
  loginInfoController.getCurrentUser
);
...
router.get(
  "/itemExistInWishList",
  authorize([role.Client]),
  wishlistController.itemExistInWishList
);
router.get(
  "/getWishlistItems",
  authorize([role.Client]),
